object Dependencies {
    ...
    object ThirdParty {
        ...
        const val kotlinxCollections =
            "org.jetbrains.kotlinx:kotlinx-collections-immutable:${Version.kotlinCollections}"
    ...
    object Test {
        ...
        const val kotlinxCoroutinesTest =
            "org.jetbrains.kotlinx:kotlinx-coroutines-test:${ThirdParty.Version.coroutines}"
        const val koinTest = "io.insert-koin:koin-test:${ThirdParty.Version.koin}"
        const val okHttp3MockWebServer =
            "com.squareup.okhttp3:mockwebserver:${Version.okHttp3MockWebServer}"
    }
